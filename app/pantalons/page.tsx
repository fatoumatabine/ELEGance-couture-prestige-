...
export const metadata = {
  title: "Pantalons - Elegance Couture",
  description: "Collection de pantalons classiques et sur mesure",
}

export default async function PantalonPage() {
  const products = await withPrismaRetry(() =>
    prisma.product.findMany({
      where: { category: "pantalons" },
      ...
      <main className="flex-1">
        <div className="relative overflow-hidden bg-[#120b06] py-12 sm:py-16 md:py-24">
          ...
          <div className="container relative mx-auto px-4 sm:px-6">
            <h1 className="mb-4 break-words text-center font-serif text-4xl font-bold tracking-wide text-[#fff8ed] sm:text-5xl md:text-7xl">Pantalons</h1>
            <p className="mx-auto max-w-2xl text-center text-base leading-relaxed tracking-wide text-[#f2d9ad] md:text-lg">
              Découvrez notre collection de pantalons élégants et confortables 👖
            </p>
          </div>
        </div>
