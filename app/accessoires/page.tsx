...
export const metadata = {
   title: "Accessoires - Elegance Couture",
   description: "Accessoires de mode pour compléter vos créations",
 }
      ...
      <main className="flex-1">
        <div className="relative overflow-hidden bg-[#120b06] py-12 sm:py-16 md:py-24">
          ...
          <div className="container relative mx-auto px-4 sm:px-6">
            <h1 className="mb-4 break-words text-center font-serif text-4xl font-bold tracking-wide text-[#fff8ed] sm:text-5xl md:text-7xl">Accessoires</h1>
