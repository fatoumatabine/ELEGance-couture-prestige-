...
export const metadata = {
  title: "Parfums - Sella Seduction",
  description: "Collection exclusive de parfums sensoriels et envoûtants",
}

export default async function ParfumsPage() {
  const products = await withPrismaRetry(() =>
    prisma.product.findMany({
      where: { category: "parfums" },
      ...
      <main className="flex-1">
        <div className="relative overflow-hidden bg-[#120b06] py-12 sm:py-16 md:py-24">
          ...
          <div className="container relative mx-auto px-4 sm:px-6">
            <h1 className="mb-4 break-words text-center font-serif text-4xl font-bold tracking-wide text-[#fff8ed] sm:text-5xl md:text-7xl">Parfums</h1>
